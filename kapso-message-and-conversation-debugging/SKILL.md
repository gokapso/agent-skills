---
name: kapso-message-and-conversation-debugging
...
- `node /agent-skills/kapso-message-and-conversation-debugging/scripts/messages.js --help`
- `bun /agent-skills/kapso-message-and-conversation-debugging/scripts/messages.js --help`
