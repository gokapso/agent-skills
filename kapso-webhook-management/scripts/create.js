...
const { buildWebhookPayload } = require('./lib/webhook');
      ...
      JSON.stringify(
        {
          ok: true,
          usage:
            'node /agent-skills/kapso-webhook-management/scripts/create.js --url <https://...> --events <csv|json-array> [--phone-number-id <id>] [--scope config|project] [--payload-version v1|v2] [--buffer-enabled true|false] [--buffer-window-seconds <n>] [--max-buffer-size <n>] [--inactivity-minutes <n>] [--headers <json>] [--active true|false]',
