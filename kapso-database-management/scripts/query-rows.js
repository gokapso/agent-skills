...
const { hasHelpFlag, parseFlags, requireFlag, parseJsonObjectOptional, parseNumber } = require('./lib/args');
      ...
      JSON.stringify(
        {
          ok: true,
          usage:
            'node /agent-skills/kapso-database-management/scripts/query-rows.js --table <name> [--filters <json>] [--select <cols>] [--order <col.asc|desc>] [--limit <n>] [--offset <n>]',
