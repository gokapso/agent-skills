---
name: kapso-database-management
...
- `node /agent-skills/kapso-database-management/scripts/list-tables.js --help`
- `bun /agent-skills/kapso-database-management/scripts/list-tables.js --help`
