      ...
      JSON.stringify(
        {
          ok: true,
          usage:
            'node /agent-skills/kapso-ops/scripts/update.js --webhook-id <id> [--phone-number-id <id>] [--scope config|project] [--url ...] [--events ...] [--payload-version v1|v2] [--buffer-enabled true|false] [--buffer-window-seconds <n>] [--max-buffer-size <n>] [--inactivity-minutes <n>] [--headers <json>] [--active true|false]',
