      ...
      JSON.stringify(
        {
          ok: true,
          usage:
            'node /agent-skills/kapso-error-and-log-triage/scripts/errors.js [--period <24h|7d|30d>] [--source <message_delivery|api_call|webhook_delivery>] [--limit <n>] [--page <n>] [--phone-number <e164>]',
