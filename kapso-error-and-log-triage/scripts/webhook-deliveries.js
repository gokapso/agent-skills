      ...
      JSON.stringify(
        {
          ok: true,
          usage:
            'node /agent-skills/kapso-error-and-log-triage/scripts/webhook-deliveries.js [--period <24h|7d|30d>] [--status <value>] [--event <value>] [--webhook-id <id>] [--errors-only true|false] [--page <n>] [--per-page <n>]',
