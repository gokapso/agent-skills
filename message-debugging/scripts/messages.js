      ...
      JSON.stringify(
        {
          ok: true,
          usage:
            'node /agent-skills/message-debugging/scripts/messages.js [--direction <inbound|outbound>] [--status <pending|sent|delivered|read|failed>] [--phone-number <e164>] [--conversation-id <uuid>] [--message-type <text|image|audio|video|document>] [--whatsapp-config-id <id>] [--has-media true|false] [--page <n>] [--per-page <n>]',
