...
Public Cloudflare function invokes receive sanitized inbound request headers, including common webhook signature headers. Use `request.headers.get(...)` in the function to verify provider signatures.
